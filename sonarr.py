...
with open('tvdb_auth.api', 'r') as myfile:
    auth_string = myfile.read().replace('\n', '')
...
# for testing purposes. will add imdb url and search function
#imdb_id = "tt2649356" #sharp objects
imdb_id = "tt0460649" #himym
#imdb_id = "tt6048596" #sinner
